...
describe('V2 Base Coin:', function() {
  ...
  describe('Token initialization', function() {
    it('ERC20 Tokens initialized with name and contract should be instances of Erc20Token', function() {
      (basecoinErc20TokenWithName instanceof Erc20Token).should.equal(true);
      (basecoinErc20TokenWithContractHash instanceof Erc20Token).should.equal(true);
    });

    it('ERC20 Tokens initialized with name and contract should be instances of each others constructor', function() {
      (basecoinErc20TokenWithName instanceof basecoinErc20TokenWithContractHash.constructor).should.equal(true);
      (basecoinErc20TokenWithContractHash instanceof basecoinErc20TokenWithName.constructor).should.equal(true);
    });
