...
describe('XLM:', function() {
  ...
  it('Should explain an XLM transaction', co(function *() {
    ...
    signedExplanation.outputAmounts.should.have.property('txlm');
    signedExplanation.outputAmounts.txlm.should.equal('5000000000');
    ...
    unsignedExplanation.outputAmounts.should.have.property('txlm');
    unsignedExplanation.outputAmounts.txlm.should.equal('10000000000');
  ...
  it('Should explain a token transaction', co(function *() {
    ...
    explanation.changeOutputs.length.should.equal(0);
    explanation.changeAmount.should.equal('0');
    explanation.outputAmounts.should.have.property('txlm:BST-GBQTIOS3XGHB7LVYGBKQVJGCZ3R4JL5E4CBSWJ5ALIJUHBKS6263644L');
    explanation.outputAmounts['txlm:BST-GBQTIOS3XGHB7LVYGBKQVJGCZ3R4JL5E4CBSWJ5ALIJUHBKS6263644L'].should.equal('500000000');
  }));
